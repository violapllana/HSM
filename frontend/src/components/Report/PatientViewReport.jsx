...
//           withCredentials: true, // shumë e rëndësishme që cookie të dërgohet
//         });
...
//               <strong>Doctor:</strong> {report.Doctor?.name} {report.Doctor?.surname} ({report.Doctor?.specialization})<br />
//               <strong>Email:</strong> {report.Doctor?.email} {/* Shfaq Emailin e Doktorit */}
//             </p>
//           </div>
//         ))
//       )}
