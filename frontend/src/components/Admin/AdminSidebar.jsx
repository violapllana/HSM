        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <aside className="bg-gray-100 border-r-2 border-gray-300 p-4 w-64 overflow-y-auto">
            <ul className="space-y-2">
              ...
              <li>
                <button onClick={() => setActiveTab('adminpanel')} className="block p-2 font-bold text-gray-800 hover:bg-blue-500 hover:text-white rounded">
                  Manage Admins
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('doctorpanel')} className="block p-2 font-bold text-gray-800 hover:bg-blue-500 hover:text-white rounded">
                  Manage Doctors
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('patientpanel')} className="block p-2 font-bold text-gray-800 hover:bg-blue-500 hover:text-white rounded">
                  Manage Patients
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('connect')} className="block p-2 font-bold text-gray-800 hover:bg-blue-500 hover:text-white rounded">
                  Connection
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('departments')} className="block p-2 font-bold text-gray-800 hover:bg-blue-500 hover:text-white rounded">
                  Departments
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('appointmentform')} className="block p-2 font-bold text-gray-800 hover:bg-blue-500 hover:text-white rounded">
                  Create Appointment
                </button>
              </li>
